package edu.KarryCode.MapReduceForCVLike.S2;
...
//        Job job = Job.getInstance(super.getConf(), "CV_Like");
        ...
        TextInputFormat.addInputPath(job,new Path("CV_Like_S1_output\\part-r-00000"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("CV_Like_S2_output"));
