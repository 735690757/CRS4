package edu.KarryCode.MapReduceForCVLike.S1;
...
//        Job job = Job.getInstance(super.getConf(), "CV_Like");
        ...
        TextInputFormat.addInputPath(job,new Path("CV_Like_S1_input\\SourceData.txt"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("CV_Like_S1_output"));
